...
# copy over source mods for embedded python
cp -f examples/python/embedded_python/gplsrc/*  gplsrc
...
# make using our special makefile py_Makefile
sudo make -f examples/python/embedded_python/py_Makefile
