...
of Debian, Ubuntu, Mint CachyOS and Fedora.  SD should run on recemtdistributions based on Arch,
Debian, Ubuntu or Fedora.  The installer has also installed the database successfully on Ubuntu running
